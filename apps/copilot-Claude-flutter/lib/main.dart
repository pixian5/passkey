...
void main() {
  runApp(const CopilotClaudeDesktopApp());
}

class CopilotClaudeDesktopApp extends StatelessWidget {
  const CopilotClaudeDesktopApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Copilot Claude Flutter',
...
class _DesktopHomePageState extends State<DesktopHomePage> {
  ...
  final _deviceController = TextEditingController(text: 'CodexDesktop');
  final _usernameController = TextEditingController();
  final _passwordController = TextEditingController();
  final _noteController = TextEditingController();
  String _deviceName = 'CodexDesktop';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('copilot-Claude-flutter'),
        actions: [
          IconButton(
